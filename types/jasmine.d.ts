...
declare function waitsFor(latchMethod: () => boolean, timeout?: number): void;
...
declare module jasmine {
    ...
    interface Matchers {
        ...
        toEqualAndDisplayDiff(expected: any, options?: { ignoreNonEqualPathsMatching?: RegExp; }): boolean;
